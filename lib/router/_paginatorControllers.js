...
PaginatorController = PaginatorBaseController.extend({
	...
	subscriptions: function() {
		Bisia.Ui.pageReady = Meteor.subscribe(this.subsTo, {}, this.findOptions(), this.getAuthor(), function() {
...
BirthdayController = PaginatorController.extend({
	...
	subscriptions: function() {
		Bisia.Ui.pageReady = Meteor.subscribe(this.subsTo, this.findOptions(), function() {
			Bisia.Ui.hideElement('.list', 'bottom-show');
		});
	},
	items: function() {
