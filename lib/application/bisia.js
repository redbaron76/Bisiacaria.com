...
Bisia = {
	...
	/**
	 * replace all chars not in regex
	 * @param  {String} fbUsername
	 * @return {String}
	 */
	normalizeUsername: function(fbUsername) {
		fbUsername = fbUsername.trim();
		fbUsername = fbUsername.replace(/ /g, '.');
		return fbUsername.replace(/[^a-zA-Z0-9-_.]/g, '');
	},
	...
	trimSpaces: function(str) {
		...
		// replace first space with repChar
